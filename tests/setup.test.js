...
import { buildTestApp, createTestDB, DEVICE_MAC, DEVICE_MAC_2, } from "./helpers.js";
describe("GET /api/setup", () => {
    ...
    it("api_key is a valid UUID v4 format", async () => {
        ...
        expect(api_key).toMatch(/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i);
    });
